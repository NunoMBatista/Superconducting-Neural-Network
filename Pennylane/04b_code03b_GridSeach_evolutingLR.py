"""
Run as:
    python3 04b_code03b_GridSeach_evolutingLR.py --data-dir ./Datasets/dataset_250_4by4 --img-size 4 --max-epochs 20 --patience 10 --output-dir ./Code02_epochs20
"""
...
# --- The Updated Runner with Early Stopping and Cosine Annealing ---
def run_and_save(config, data, run_dir, max_epochs, patience=5, min_delta=1e-4):
    ...
    # Schedule starts at config['lr'] and decays to 1% of that value over total_steps
    ...
    # Initialize Optimizer with the schedule
    ...
    metrics = {
        ...
        "training_time_sec": float(train_time), "epochs_completed": final_epoch_count, 
        "config": config, "lr_schedule": "cosine_decay"
    }
